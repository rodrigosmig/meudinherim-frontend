...
export const transferValidation = yup.object().shape({
  ...
  source_category_id: yup.number().integer("Categoria inválida").moreThan(0, "O campo categoria de origem é inválido").typeError("O campo categoria de origem é inválido"),
  destination_category_id: yup.number().integer("Categoria inválida").moreThan(0, "O campo categoria de destino é inválido").typeError("O campo categoria de destino é inválido"),
  source_account_id: yup.number().integer("Conta inválida").moreThan(0, "O campo conta de origem é inválido").typeError("O campo conta de origem é inválido"),
  destination_account_id: yup.number().integer("Conta inválida").moreThan(0, "O campo conta de destino é inválido").typeError("O campo conta de destino é inválido"),
})