    ...
    <>
      <DropdownMenu.Root>
        ...
        <DropdownMenu.Content align={align} className="w-64">
          ...
          <AdicionarItem icon={BanknoteArrowUp} label="Contas a Pagar" onClick={() => setFormAberto("conta-a-pagar")} />
          <AdicionarItem icon={BanknoteArrowDown} label="Contas a Receber" onClick={() => setFormAberto("conta-a-receber")} />
